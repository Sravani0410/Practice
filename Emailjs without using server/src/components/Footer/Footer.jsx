...
const Footer = ()=>{
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_oj7kznl', 'template_8p37v88', form.current, 'TwQE2s9pVt7IQy-BL')
          .then((result) => {
    ...
    return(
            ...
            <div class="container-footer">
                    <div class="footer-left-part">
                        <img src={greencell_logo} class="footer_logo" alt=""/>
                        <div className="row-element">
                            <img src={addressIcon} alt="" />
                        <div>
                            <p>Unit No. 405, 4th Floor, ‘E’ Wing,<br />
                        ...
                        <div className="row-element"> 
                            ...
                            <a href="mailto:contact@greencellmobility.com" >contact@greencellmobility.com</a>
                         </div>
                        <div className="row-element" > 
                            <a href="https://www.linkedin.com/company/greencell-mobility/">
                                <img src={linkedIn} class="me-2" alt=""></img></a> 
                            <a href="https://twitter.com/greencellev">
                                <img src={twitter} alt=""></img></a>
                                <a target="_blank" href="https://api.whatsapp.com/send?phone=919930000446&text=Hello this is the starting message"> <img src={whatsapp} alt=""/></a>
                         </div>
